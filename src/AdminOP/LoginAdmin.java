...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    public void login() throws SQLException {
        ...
        if (txt_email.getText().equals("") || txt_pwd.getPassword().equals("")) {
            JOptionPane.showMessageDialog(this, "Please make sure that none of the fields are blank.", "Entry Error", 1);
        } else {

            admin.setUserName(txt_email.getText());
            admin.setPassword(txt_pwd.getText());

            admin = ds.getAdmin(admin);

            if (admin.getId()== 0) {
                loader.hide();
//            JOptionPane.showMessageDialog(this, , "Entry Error", 1);
    ...
    private void initComponents() {
        ...
        login.add(txt_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(164, 157, 302, 30));
        ...
        jLabel6.setFont(new java.awt.Font("Lemonada SemiBold", 0, 24)); // NOI18N
        jLabel6.setText("Login Admin");
        login.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(164, 69, 270, -1));

        btSave.setFont(new java.awt.Font("Lemonada SemiBold", 1, 14)); // NOI18N
        btSave.setForeground(new java.awt.Color(255, 102, 0));
        btSave.setText("LogIN ");
        btSave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSaveActionPerformed(evt);
            }
        });
        login.add(btSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 290, 330, -1));
 ...
 if (JOptionPane.showConfirmDialog(null, "Are you sure to close window ", "Warning", JOptionPane.WARNING_MESSAGE) == 0)
    ...
    private void btSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSaveActionPerformed
        try {
            ...
            Logger.getLogger(LoginAdmin.class.getName()).log(Level.SEVERE, null, ex.getMessage());
        }
